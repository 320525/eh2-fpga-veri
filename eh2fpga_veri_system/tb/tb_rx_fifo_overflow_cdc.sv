...
module tb_rx_fifo_overflow_cdc;
  ...
  eh2_system_controller #(
    .PROGRAM_TIMEOUT_CYCLES(100), .SOFT_RESET_CYCLES(2),
    ...
    .program_dma_busy(1'b0), .data_atg_done(1'b0),
    ...
    .eh2_stopped(2'b00), .eh2_axi_idle(1'b1), .log_tx_all_done(1'b0),
    .fatal_error_pending(fatal_pending), .fatal_error_code(fatal_code),
    .info_tx_full(1'b0), .info_frame_done(1'b0),
    .info_sent_code(32'b0), .info_tx_push(), .info_tx_code(),
