...
`include "eh2_param.vh"
  ...
  (
   ...
   output logic [pt.NUM_THREADS-1:0] dec_tlu_i0_commit_wb,         // ungated i0 commit at WB
   output logic [pt.NUM_THREADS-1:0] dec_tlu_i1_commit_wb,         // ungated i1 commit at WB
   ...
   // ================================================================================
     for (genvar i=0; i<pt.NUM_THREADS; i++) begin : tlumt
        eh2_dec_tlu_ctl #(.pt(pt)) tlu (//inputs
                                         ...
                                         .tlu_i0_commit_wb(dec_tlu_i0_commit_wb[i]),
                                         .tlu_i1_commit_wb(dec_tlu_i1_commit_wb[i]),
