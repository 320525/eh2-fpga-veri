...
`include "eh2_param.vh"
  ...
  (
   ...
   // Ungated WB commit valids for the architectural commit monitor.
   output logic tlu_i0_commit_wb,
   output logic tlu_i1_commit_wb,
...
if (pt.FAST_INTERRUPT_REDIRECT) begin
   ...
   assign tlu_i0_commit_wb = i0_valid_wb;
   assign tlu_i1_commit_wb = i1_valid_wb;
