...
`include "eh2_param.vh"
   ...
   assign lsu_axi_awid[pt.LSU_BUS_TAG-1:0] = 4'({bus_tid,obuf_tag0[bus_tid][pt.LSU_BUS_TAG-2:0]});
   ...
   assign lsu_axi_arid[pt.LSU_BUS_TAG-1:0] = 4'({bus_tid,obuf_tag0[bus_tid][pt.LSU_BUS_TAG-2:0]});
