...
package eh2_system_pkg;
  ...
  typedef enum logic [2:0] {
    ...
    DDR1_OWNER_INFO_WRITE = 3'd4,
    DDR1_OWNER_INFO_READ  = 3'd5
  } ddr1_owner_t;
  ...
  // State-independent WebUI operator command.  The controller forwards this
  // to the existing board-equivalent global reset supervisor.
  localparam logic [31:0] HOST_GLOBAL_RESET= 32'h4413_4445;
  // Host request used after a discontinuous/incomplete information-log dump.
  // It is accepted only in END after the first dump and causes a complete
  // hart0-then-hart1 replay from DDR1; DDR1 is deliberately retained.
  localparam logic [31:0] HOST_INFO_RETRANSMIT_ALL = 32'h4414_4445;
  ...
  localparam logic [31:0] ERR_INFO_FIFO_H0 = 32'h6666_00C1;
  localparam logic [31:0] ERR_INFO_FIFO_H1 = 32'h6666_00C2;
  localparam logic [31:0] ERR_INFO_DMA      = 32'h6666_00C3;
  localparam logic [31:0] ERR_INFO_DUMP     = 32'h6666_00C4;
  localparam logic [31:0] ERR_WAW_CAUSE_H0 = 32'h6666_00C5;
  localparam logic [31:0] ERR_WAW_CAUSE_H1 = 32'h6666_00C6;
  localparam logic [31:0] ERR_INFO_DUMP_READ_PROTOCOL = 32'h6666_00C7;
  localparam logic [31:0] ERR_INFO_DUMP_FRAME_PROTOCOL = 32'h6666_00C8;
  localparam logic [31:0] ERR_INFO_DUMP_RELEASE = 32'h6666_00C9;
  // Keep C1/C2 reserved for a physical XPM FIFO write overflow.  The old
  // implementation ORed the following logically independent stages into
  // those codes, which made a board failure impossible to localize.
  localparam logic [31:0] ERR_INFO_QUEUE_H0   = 32'h6666_00D1;
  localparam logic [31:0] ERR_INFO_QUEUE_H1   = 32'h6666_00D2;
  localparam logic [31:0] ERR_INFO_CAPTURE_H0 = 32'h6666_00D3;
  localparam logic [31:0] ERR_INFO_CAPTURE_H1 = 32'h6666_00D4;
  localparam logic [31:0] ERR_ILLEGAL_STATE= 32'h6666_00F1;
  // Replay delimiter.  The host discards all prior partial log data only
  // after this system frame, then collects a new full DDR1 dump generation.
  localparam logic [31:0] MSG_INFO_RETRANSMIT_BEGIN = 32'h7777_0001;
