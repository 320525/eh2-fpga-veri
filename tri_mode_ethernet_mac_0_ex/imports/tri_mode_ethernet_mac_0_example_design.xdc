# PART is virtexuplus xcvu19pfsva3824
...
create_waiver -quiet -type DRC -id {REQP-1839} -user "tri_mode_ethernet_mac" -desc "REQP-1839 is waived as the resets to BRAM are synchronous in nature sourced from a reset-synchronizer module which is falsely flagged as async-reset source" -tags "1166647" -objects [get_cells -hier -filter {REF_NAME==RAMB36E2 && NAME=~ trimac_fifo_block/user_side_FIFO/rx_fifo_i/rx_ramgen_i/mem_reg_bram_0}]
create_waiver -quiet -type DRC -id {REQP-1839} -user "tri_mode_ethernet_mac" -desc "REQP-1839 is waived as the resets to BRAM are synchronous in nature sourced from a reset-synchronizer module which is falsely flagged as async-reset source" -tags "1166647" -objects [get_cells -hier -filter {REF_NAME==RAMB36E2 && NAME=~ trimac_fifo_block/user_side_FIFO/tx_fifo_i/tx_ramgen_i/mem_reg_bram_0}]
create_waiver -quiet -type DRC -id {REQP-1839} -user "tri_mode_ethernet_mac" -desc "REQP-1839 is waived as the resets to BRAM are synchronous in nature sourced from a reset-synchronizer module which is falsely flagged as async-reset source" -tags "1166647" -objects [get_cells -hier -filter {REF_NAME==RAMB36E1 && NAME=~ trimac_fifo_block/user_side_FIFO/rx_fifo_i/rx_ramgen_i/mem_reg*}]
create_waiver -quiet -type DRC -id {REQP-1839} -user "tri_mode_ethernet_mac" -desc "REQP-1839 is waived as the resets to BRAM are synchronous in nature sourced from a reset-synchronizer module which is falsely flagged as async-reset source" -tags "1166647" -objects [get_cells -hier -filter {REF_NAME==RAMB36E1 && NAME=~ trimac_fifo_block/user_side_FIFO/tx_fifo_i/tx_ramgen_i/mem_reg*}]
