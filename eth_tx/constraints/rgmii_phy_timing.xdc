...
# These are the first metastability-catching stages of explicit two-flop
# synchronizers.  Only their D pins are asynchronous; the second stages remain
# fully timed in the 125 MHz receive/DataMover domain.
